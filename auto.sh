...
curl -O https://cdn.jsdelivr.net/gh/Zeedun0432/reinstall@main/reinstall.sh || \
wget -O reinstall.sh https://cdn.jsdelivr.net/gh/Zeedun0432/reinstall@main/reinstall.sh
